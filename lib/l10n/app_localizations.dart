...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'To add a car, type the name and press \"Add Car\". Select a car to view, update, or delete it. On a large screen, details appear beside the list.'**
